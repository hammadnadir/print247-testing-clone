...
const ArtwokComFolding = ({ mainFile, setMainFile, loader, setLoader }) => {
  ...
  return (
    <div>
      {mainFile?.length === 0 && (
        ...
        // </div>
        <div className="upload">
        <label className="uploadLabel" style={{ display: "flex", alignItems: "center", gap: "15px", justifyContent: "center" }}>
        <div style={{ display: "flex", justifyContent: "end", width: "full" }}>
            <img src="/image/Icon feather-upload.png" alt="upload icon" />
          </div>
          <div style={{display: "flex", flexDirection: "column"}}>
            <input onChange={handleFileUpload} disabled={loader} accept=".ai, .pdf, .eps, .zip" type="file" className="uploadInput"/>
            Upload Design{" "}
...
export default ArtwokComFolding;
