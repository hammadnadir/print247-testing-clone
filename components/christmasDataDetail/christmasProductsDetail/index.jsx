...
function ChristmasProductsDetail() {
  ...
  const data = [
    {
      ...
      // image: "/image/Christmas/product/cookie/cookie_product1.webp",
    },
    {
      id: 2,
                  ...
                  {headShowPath &&
                    <div className="outsidee-boxes">
                      <div style={{ borderTopLeftRadius: "20px", borderBottomLeftRadius: "20px"}}
                        ...
                        className={`${pageId === "mailer-boxes" ? "boxes1" : "boxes"}`}>
                        <Image src="/image/mailersmall.png" width={86} height={78} alt="Mailer Box product image"/>
                        <h4>Mailer Box</h4>
                      </div>

                      <div onClick={() => handleSetSelected("/product-boxes")} className={`${pageId === "product-boxes" ? "boxes1" : "boxes" }`}>
                        <Image src="/image/productsmall.png" width={86} height={78} alt="Product Box image"/>
                        <h4>Product Box</h4>
                      </div>

                      <div style={{ borderTopRightRadius: "20px", borderBottomRightRadius: "20px"}}
                        onClick={() => handleSetSelected("/shipping-boxes")}
                        className={`${pageId === "shipping-boxes" ? "boxes1" : "boxes"}`}>
                        <Image src="/image/shippingsmall.png" width={86} height={78} alt="Shipping Box image"/>
                        <h4>Shipping Box</h4>
                      </div>
                    </div>
                  }
...
export default ChristmasProductsDetail;