...
function ProductStand({ sectionRef }) {

  const router = useRouter();
  const { id } = router.query;

  const contentTableClass = router.asPath === "/boxes-campaign/folding-carton" || router.asPath === "/mylar/custom-mylar-bags";

  return (
    <div className="product_stand_margin" ref={sectionRef}>
      <Container>
