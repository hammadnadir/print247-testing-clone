...
import SingleFormSticker from "./SingleFormMylar";
...
function SingleMylarCompaign({minQuantity, sectionRef, scrollToSection, setIsSlideUpHeight, isSlideUp, setIsSlideUp }) {
...
export default SingleMylarCompaign;