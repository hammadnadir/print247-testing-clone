          ...
          {data?.id && (
            <>
              ...
              {notFound ? (
                ...
                (<div>
                  {detailData?.page_slug === "boxes-packaging" ? (
                    <PackagingDetail />
                  ) : detailData?.page_slug === "mylar-bags" ? (
                    <PackagingDetail />
                  ) : detailData?.page_slug === "labels-stickers" ? (
                    <PackagingDetail />
                  ) :
                    detailData?.page_slug === "signs-banners" ? (
                      <DetailvinylSection />
                    ) : detailData?.page_slug === "business-cards" ? (
                      <PackagingDetail />
                    ) : detailData?.page_slug === "print-products" ? (
                      <PackagingDetail />
                    ) : (
                      <PackagingDetail />
                    )}
                  {/* <SocialSlider/> */}
                  <Description showFullContent={showFullContent} setShowFullContent={setShowFullContent} />
                  <ChatTwo />
                </div>)
              }
              <Footer />
