...
function Header({ isWhiteColor = false }) {
      ...
      <div>
        ...
        {data.rows.map((row, index) => (
          <div key={index}>
            ...
            {expandedIndex === index && (
              <div style={{ paddingLeft: "20px" }}>{row.content}</div>
            )}
          </div>
        ))}
      </div>
        ...
        title: (
          <>
            <div
              ...
              <Link href={industry?.links ? industry?.links : router.asPath} className="sub-menus-mobile">
                <p>{industry.title}</p>
              </Link>
            </div>
          </>
        ...
        <div className="top_data">
          <div className="main_icons">
            ...
            <Link href="/">
              ...
              {/* <Image className="Print247-Logo" src={isWhiteColor ? "/logchristmas/Asset 3.png" : "/logchristmas/Asset 2.png"} width={185} height={45} alt="logo icon" /> */}
            </Link>
          </div>
          ...
          <div className="outside-input-field" >
            ...
            <Link href="/">
              ...
              {/* <Image className="Print247-Logo-mobile" src={isWhiteColor ? "/logchristmas/Asset 3.png" : "/logchristmas/Asset 2.png"} width={185} height={45} alt="logo" /> */}
            </Link>
                ...
                {searchData?.data
                  ...
                  .map((item, i) => {
                    if (hideCategories.includes(item?.slug)) {
                      ...
                      return (
                        <Link key={i} href={itemData?.completeSlug ? itemData?.completeSlug : router.asPath}>
                    ...
                    } else if (item?.type === "product" && item?.slug?.includes("christmas")) {
                      return (
                ...
                <div id="container">
                  <button className="learn-more">
                    <span className="circle" aria-hidden="true">
                      <img className="icon arrow" src="/image/pencil.svg" alt="edit icon" />
                    </span>
      ...
      <div className={`styling-header-mobile side_menu_res ${showMenu ? "show_menu" : "hidden_menu"}`} >
        ...
        <div className="mobile-ham-menu">
          <Link href="/">
            ...
            {/* <Image className="Print247-Logo" src="/logchristmas/Asset 3.png" width={115} height={30} alt="logo icon" /> */}
          </Link>
        ...
        <Link href="/custom-christmas-boxes">
          <div>
            <span style={{ color: "white", fontSize: "18px" }}>Christmas Boxes</span>
