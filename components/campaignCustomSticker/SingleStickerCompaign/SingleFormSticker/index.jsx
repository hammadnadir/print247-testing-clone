...
import ArtwokComSticker from "../../ArtwokComSticker";
import DetailSelect from "@/components/common/detailSelect";
function SingleFormSticker({ minQuantity }) {
  const fields = {
    length: "",
    width: "",
    depth: "",
  ...
  const materialData = [
    { slug: 'holographic', title: 'Holographic', abbr: "HOLO" },
    { slug: 'silver', title: 'Silver', abbr: "SIL" },
    { slug: 'white', title: 'White', abbr: "WHI" },
    { slug: 'vinyl', title: 'Vinyl', abbr: "VIN" },
    { slug: 'clear', title: 'Clear', abbr: "CLR" },
  ]
...
export default SingleFormSticker;
