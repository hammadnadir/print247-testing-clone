...
import ContactFaqs from '@/components/contact_us/contactFaqs';
import { contactsDataRequest } from '@/redux/contacts';
...
export const getServerSideProps = wrapper.getServerSideProps(
  store => async ({ req, res }) => {
    await Promise.all([
      ...
      store.dispatch(contactsDataRequest()),
      store.dispatch(metaDataRequest("contact-us")),
    ]);
  }
);
