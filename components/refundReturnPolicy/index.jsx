...
const ReturnRefundPolicy = () => {
  return (
    <div
      className="return_res"
    >
      <Container>
        <h1 className="title_refund_policy change_color">
        Return and Refund Policy
        </h1>
        <hr />
        <section style={{ marginBottom: "20px" }}>
          <p className="refund_policy_para">
          We have a ‘3 business days return policy,’ which means you have 3 business days after receiving your item to request a return.          </p>
          <p className="refund_policy_para">
...
by mail
          ...
          <p className="refund_policy_para change_color_dark">
          <span style={{color: "red"}}>*</span> Return and refund will only be applicable if both the aforementioned and below-mentioned conditions are simultaneously complied.  
          </p>
          <p className="refund_policy_para">
        ...
        <section style={{ marginBottom: "20px" }}>
          <h2 style={{ fontSize: "25px", fontWeight: "600", color: "#000000" }}>What to Look Before ‘Return’?</h2>
          <ul>
            ...
            <li className="refund_policy_para">
             ...
             Our official turnaround time is <span className="change_color">12 to 15</span> business days, but it can rarely be extended to a few days more due to some high-end color matching, time-consuming screen printing, delicate foil printing, etc. 

            </li>
            <li className="refund_policy_para change_color">
        ...
        <section style={{ marginBottom: "20px" }}>
          <h2 style={{ fontSize: "25px", fontWeight: "600", color: "#000000" }}>What Can You Return?
        ...
        <section style={{ marginBottom: "20px" }}>
          <h2 style={{ fontSize: "25px", fontWeight: "600", color: "#000000" }}>Different Scenarios To Consider
          </h2>

          <ul>
            <li className="refund_policy_para">
              Returns and refunds become acceptable if we (Print 247) have printed and produced packaging products that are dissimilar to the final approved digital proof, computer-generated 3D mockup or physical prototype of the ‘ordered packaging product.’
        ...
        <section style={{ marginBottom: "20px" }}>
          <h2 style={{ fontSize: "25px", fontWeight: "600", color: "#000000" }}>How Do We Help?
          </h2>
          <ul>
            <li className="refund_policy_para">
        ...
        <section style={{ marginBottom: "20px" }}>
          <h2 style={{ fontSize: "25px", fontWeight: "600", color: "#000000" }}>
