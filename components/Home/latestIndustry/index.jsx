...
function LatestIndustry() {
    ...
    const industryTwo = [
        {
            id: 1,
            imgSrc: "/home/latestIndustry/automative4.webp",
        ...
        {
            id: 2,
            imgSrc: "/home/latestIndustry/industry8.webp",
    ...
    return (
        <div className='new_container'>
            <div className='new_industry_supplies'>
                ...
                <Slider {...settings}>
                    ...
                    <div className="industry_grid_main">
                        <div className="industry_grid_1">
                            {industryOne.map((industry, index) => (
                                industry.links ? (
                                    <Link href={industry.links} key={index}>
                                        <div className="inner_industry_grid_1">
                                            <img src={industry.image} alt="industry image" />
                                            <div className={`coming_soon ${industry.stock === "New" ? "new-stock" : industry.stock === "Coming Soon" ? "coming-soon-stock" : ""}`}>
                                            ...
                                            <div className="industry_details">
                                                <div className="indus_title_arr">
                                                    ...
                                                    <img src="/home/latestIndustry/arr_home.png" alt="arrow icon" />
                                                </div>
                                    ...
                                    <div className="inner_industry_grid_1" key={index}>
                                        <img src={industry.image} alt="industry image" />
                                        <div className={`coming_soon ${industry.stock === "New" ? "new-stock" : industry.stock === "Coming Soon" ? "coming-soon-stock" : ""}`}>
                                            <div className="coming_soon_bg">
                                                <p>{industry.stock}</p>
                        ...
                        <div className='industry_grid_2'>
                            {industryTwo.map((item) => (
                                item.links ? (
                                    ...
                                    <div className='inner_industry_grid_2' key={item.id}>
                                        <img src={item.imgSrc} alt={item.title} />
                                        <div className={`coming_soon ${item.stock === "New" ? "new-stock" : item.stock === "Coming Soon" ? "coming-soon-stock" : ""}`}>
                                            <div className="coming_soon_bg">
                                                <p>{item.stock}</p>
                        ...
                        <div className="industry_grid_3">
                            {industryThree.map((item) => (
                                item.links ? (
                                    ...
                                    <div className="inner_industry_grid_3" key={item.id}>
                                        <img src={item.image} alt="industry image" />
                                        <div className={`coming_soon ${item.stock === "New" ? "new-stock" : item.stock === "Coming Soon" ? "coming-soon-stock" : ""}`}>
                                            <div className="coming_soon_bg">
                                                <p>{item.stock}</p>
