...
import SingleFormSticker from "../SingleStickerCompaign/SingleFormSticker";
import ReactStars from "react-rating-stars-component";
import { useRouter } from "next/router";
import { boxCompaignData } from "@/data/boxCompaignData";

const images = [
    "/customSticker/mainSticker/new_stick1.webp",
    "/customSticker/mainSticker/new_stick2.webp",
    "/customSticker/mainSticker/new_stick3.webp",
    "/customSticker/mainSticker/new_stick4.webp",
];
...
const MainSlider = ({ minQuantity, scrollToSection, sectionRef = { sectionRef } }) => {
    ...
    return (
        <div className="carouselContainers">
            ...
            <div className="width_set_form_stickers">
                <div className="form_bg_color_stickers">
