...
import ArtwokComSticker from "../../ArtwokComMylar";
import ArtwokComMylar from "../../ArtwokComMylar";
import DetailSelect from "@/components/common/detailSelect";

function SingleFormMylar({ minQuantity }) {
  const fields = {
    length: "",
    width: "",
    depth: "",
  ...
  return (
    <div className="single_form_Section_fold">
      <form style={{ display: "none" }} ref={reftwo} className="form" onSubmit={handleSubmit}>
      ...
      <form ref={ref} className="form" onSubmit={handleSubmit}>
        ...
        <div className="formGroupTwo">
          ...
          /> */}
          <Select style={{ backgroundColor: "transparent", minWidth: "80px" }} className="select inchSelect" showSearch placeholder="inch"
            defaultValue={{ value: "inch", label: "inch" }}
...
export default SingleFormMylar;
