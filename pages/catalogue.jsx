...
import Featureproduct from '@/components/Featured/Featureproduct'
import ChatTwo from '@/components/Home/chatTwo'
import { catalogDataRequest } from '@/redux/catalog'
...
export const getServerSideProps = wrapper.getServerSideProps(
  store => async ({ req, res }) => {
    await Promise.all([
      ...
      store.dispatch(catalogDataRequest()),
      store.dispatch(metaDataRequest("catalogue")),
    ]);
  }
);
