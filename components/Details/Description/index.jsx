...
function Description({ showFullContent, setShowFullContent }) {
  ...
  return (
    <div className="main-descriptionn">
      <Container>
        <div className="inner_des_title">
          {detailData?.description && (
            <>
              <div onClick={() => setSelected(1)} className={`inerrs ${selected === 1 && "select"}`}>
                <h4>Description</h4>
              </div>
              {/* <div onClick={() => setSelected(2)} className={`inerrs ${selected === 2 && "select"}`}>
                <h4>Product Specification</h4>
              </div>
              <div onClick={() => setSelected(3)} className={`inerrs ${selected === 3 && "select"}`}>
                <h4>How you Get it</h4>
              </div> */}
            </>
          )}
        </div>
        ...
        {/* <div className="twstimonial_product">
          <Testimonial />
        </div> */}
        ...
        <div className="main-may-like">
          ...
          <div className="main_products_envelop">
            {detailData?.like_product &&
              detailData?.like_product?.map((items, index) => {
                const photoArray = items?.photo ? JSON.parse(items.photo) : [];
                    ...
                    <div className="bottom" key={index}>
                      <div className="head_envelop_image">
                        <div className="image_envelop">
                          <img src={imageUrl} alt={items.main_image_alt} title={items.main_image_title} width={492} height={539} />
                        </div>
