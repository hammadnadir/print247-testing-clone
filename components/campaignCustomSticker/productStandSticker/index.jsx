...
function ProductStandSticker({ sectionRef }) {

  const router = useRouter();
  const { id } = router.query;

  const contentTableClass = router.asPath === "/stickers/custom-sticker-a"
    ...
    <div className="product_sticker_margin" ref={sectionRef}>
      <Container>
        <div className={` ${contentTableClass ? "main_product_fold" : "main_product_stand"} `}>
          ...
          <div className={`${contentTableClass ? "content_section_sticker" : "content_section"}`}>
...
export default ProductStandSticker;