// import ShippingData from '@/components/shippingPolicy'
// import React from 'react'

// function ShippingPoilcy() {
//   return (
//     <div>
//         <ShippingData />
//     </div>
  ...
  return (
    <div>
      <Head>
        ...
        <link
          rel="canonical"
          href={`https://print247-testing-clone.vercel.app/shipping-policy`}
        />
        <meta
          name="robots"
  ...
  (store) =>
    async ({ req, res }) => {
      await Promise.all([
        ...
        store.dispatch(metaDataRequest("shipping-policy")),
      ]);
    }
);
