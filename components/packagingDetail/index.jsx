...
function PackagingDetail() {
  ...
  const photo_alt = detailData?.image_title  ? JSON.parse(detailData?.image_title) : null;
  const photo_title = detailData?.image_alt ? JSON.parse(detailData?.image_alt) : null;
  ...
  return (
    <div className="background-detail-main">
      {isViewerOpen && (
        <ImageViewer
          src={images}
      ...
      <Container>
        <div className="main-section">
          <div className="main_section_inner">
            ...
            <div className="outer_outside_bx">
              <div className="main-outsidee-boxes">
                <div className="main_products_env">
