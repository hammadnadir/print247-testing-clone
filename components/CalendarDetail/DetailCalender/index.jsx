...
function DetailCalender() {
  ...
  return (
    <div className="background-detailcalender">
       {/* {loader && <Loader />} */}
      <Container>
        <div className="main-detailcalender">
          <div className="main-calender-boxes">
            <div className="main_calender_envelop">
              {data.slice(0, 2).map((items, index) => {
                return (
                  <div className="bottom_calender" key={index}>
                    <div className="head_envelop_image">
                      <div className="image_calender">
            ...
            <div className="main_calender_enveloptwo">
              {data2.map((items, index) => {
                return (
                  <div className="bottom-calendertwo" key={index}>
                    <div className="head_envelop_image">
                      <div className="image_calendertwo">
